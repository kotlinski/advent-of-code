...
export class HotSpringsConsumer {
  private readonly memoized: ((arrangement: string, groups: number[]) => number) & MemoizedFunction;
  ...
  constructor(
    ...
    this.memoized = memoize(this.getRecursiveConsumer(), (...args) => JSON.stringify(args));
  }
